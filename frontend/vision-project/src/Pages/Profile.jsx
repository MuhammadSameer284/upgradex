...
// ─── Profile data (later comes from logged-in user's data) ────────
const PROFILE = {
    ...
    skills: ["React", "Node.js", "MongoDB", "Express", "Socket.io", "Tailwind", "JWT"],
    about: "MERN stack developer studying at Aptech, building real-world web apps and learning collaborative development through UpgradeX.",
};
        ...
        <div className="min-h-screen p-5" style={{ background: "#0a0a14" }}>
            <div className="grid gap-4" style={{ gridTemplateColumns: "280px 1fr" }}>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {/* Profile card */}
                    <div
                        className="rounded-2xl pb-4 px-4 relative"
                        style={{ background: "rgba(255,255,255,0.03)", border: "0.5px solid rgba(255,255,255,0.07)" }}
                    >
                        {/* Cover banner */}
                        <div
                            className="relative rounded-xl overflow-hidden h-24 -mx-4 -mt-0"
                        ...
                        <div className="relative" style={{ marginTop: "-36px" }}>
                            <div
                                className="w-[72px] h-[72px] rounded-2xl flex items-center justify-center text-2xl font-bold text-white relative z-10"
                        ...
                        <h1 className="text-base font-semibold text-white mt-2.5">{PROFILE.name}</h1>
                        <p className="text-xs mt-0.5 mb-3" style={{ color: "rgba(255,255,255,0.35)" }}>
                            {PROFILE.role} · {PROFILE.batch}
                        </p>
                        ...
                        {/* Info rows */}
                        {[
                            { icon: "ti-mail", value: PROFILE.email },
                            { icon: "ti-map-pin", value: PROFILE.location },
                            { icon: "ti-calendar", value: PROFILE.joined },
                            { icon: "ti-brand-github", value: PROFILE.github },
                        ].map((row, i) => (
                            <div
                                key={i}
                    ...
                    <div className="rounded-2xl p-3.5" style={{ background: "rgba(255,255,255,0.03)", border: "0.5px solid rgba(255,255,255,0.07)" }}>
                        <h3 className="text-[11px] font-medium uppercase tracking-wider mb-2.5" style={{ color: "rgba(255,255,255,0.4)" }}>
                            Skills
                        </h3>
                            ...
                            {tabs.map(t => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: activeTab === t.key ? "#AFA9EC" : "rgba(255,255,255,0.3)",
                                        cursor: "pointer",
                                    }}
                                >
                                    {t.label}
                            ...
                            {activeTab === "projects" && (
                                <div className="flex flex-col gap-2">
                                    {PROJECTS.map((p, i) => (
                                        ...
                                        >
                                            <div
                                                className="w-[38px] h-[38px] rounded-lg flex items-center justify-center text-xs font-semibold text-white flex-shrink-0"
                                ...
                                <div className="flex flex-col">
                                    {ACTIVITY.map((a, i) => (
                                        ...
                                        >
                                            ...
                                            <div className="text-xs flex-1" style={{ color: "rgba(255,255,255,0.5)", lineHeight: 1.5 }}>
                                                {a.text}
                                            </div>
                            ...
                            {activeTab === "achievements" && (
                                <div className="grid grid-cols-4 gap-2.5">
                                    {ACHIEVEMENTS.map((a, i) => (
                                        <div
                                            key={i}
                                            className="flex flex-col items-center gap-1.5 p-3.5 rounded-xl text-center"
                                            style={{ background: "rgba(255,255,255,0.03)", border: "0.5px solid rgba(255,255,255,0.07)" }}
                                        >
